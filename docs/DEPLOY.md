...
5. Check the release URL and live app manually. The release package is available from the tagged source archive; host `index.html`, `landing.html`, `bbs-flash.html`, `src/` and `assets/icon.svg` together.
